...
export const mockItemRates: ItemRate[] = [
  ...
  // Flours, Rice & Daliya
  { id: 'r21', name: 'Whole Wheat Flour 5kg', rate: 1100, unit: 'bag', category: 'Flour' },
  { id: 'r22', name: 'Maida (All Purpose Flour)', rate: 180, unit: 'kg', category: 'Flour' },
  { id: 'r23', name: 'Sooji (Semolina)', rate: 220, unit: 'kg', category: 'Flour' },
  { id: 'r24', name: 'Besan (Gram Flour)', rate: 350, unit: 'kg', category: 'Flour' },
  { id: 'r25', name: 'Rice Flour', rate: 300, unit: 'pack', category: 'Flour' },
  { id: 'r26', name: 'Cornstarch', rate: 200, unit: 'pack', category: 'Flour' },
  { id: 'r27', name: 'Basmati Rice 5kg', rate: 1500, unit: 'bag', category: 'Rice' },
  { id: 'r28', name: 'Broken Rice', rate: 180, unit: 'kg', category: 'Rice' },
  { id: 'r29', name: 'Brown Rice', rate: 350, unit: 'kg', category: 'Rice' },
  { id: 'r30', name: 'Daliya (Cracked Wheat)', rate: 250, unit: 'kg', category: 'Rice' },
  { id: 'r31', name: 'Barley (Jau)', rate: 200, unit: 'kg', category: 'Rice' },
  { id: 'r32', name: 'Millet (Bajra)', rate: 180, unit: 'kg', category: 'Rice' },
  // Lentils, Beans & Grams
  { id: 'r33', name: 'White Chickpeas (Kabuli)', rate: 450, unit: 'kg', category: 'Pulses' },
  { id: 'r34', name: 'Black Chickpeas (Kala Chana)', rate: 400, unit: 'kg', category: 'Pulses' },
  { id: 'r35', name: 'Kidney Beans (Rajma)', rate: 550, unit: 'kg', category: 'Pulses' },
  { id: 'r36', name: 'White Beans (Lobia)', rate: 380, unit: 'kg', category: 'Pulses' },
  { id: 'r37', name: 'Pigeon Peas (Toor Daal)', rate: 420, unit: 'kg', category: 'Pulses' },
  { id: 'r38', name: 'Mash Daal', rate: 500, unit: 'kg', category: 'Pulses' },
  { id: 'r39', name: 'Green Peas', rate: 400, unit: 'pack', category: 'Pulses' },
  { id: 'r40', name: 'Fried Gram (Bhuna Chana)', rate: 180, unit: 'pack', category: 'Pulses' },
  // Oils, Ghee & Fats
  { id: 'r41', name: 'Banaspati Ghee 1kg', rate: 1200, unit: 'pack', category: 'Oil & Ghee' },
  { id: 'r42', name: 'Sunflower Oil 5L', rate: 3500, unit: 'bottle', category: 'Oil & Ghee' },
  { id: 'r43', name: 'Canola Oil 5L', rate: 3200, unit: 'bottle', category: 'Oil & Ghee' },
  { id: 'r44', name: 'Mustard Oil 1L', rate: 850, unit: 'bottle', category: 'Oil & Ghee' },
  { id: 'r45', name: 'Desi Ghee 1kg', rate: 3200, unit: 'pack', category: 'Oil & Ghee' },
  { id: 'r46', name: 'Coconut Oil 500ml', rate: 850, unit: 'bottle', category: 'Oil & Ghee' },
  { id: 'r47', name: 'Olive Oil 500ml', rate: 1800, unit: 'bottle', category: 'Oil & Ghee' },
  // Spices
  { id: 'r48', name: 'Cumin (Zeera)', rate: 700, unit: 'pack', category: 'Spices' },
  { id: 'r49', name: 'Black Pepper (Kali Mirch)', rate: 400, unit: 'pack', category: 'Spices' },
  { id: 'r50', name: 'Cloves (Laung)', rate: 250, unit: 'pack', category: 'Spices' },
  { id: 'r51', name: 'Cinnamon (Dalchini)', rate: 350, unit: 'pack', category: 'Spices' },
  { id: 'r52', name: 'Cardamom (Elaichi)', rate: 850, unit: 'pack', category: 'Spices' },
  { id: 'r53', name: 'Coriander (Dhania)', rate: 250, unit: 'pack', category: 'Spices' },
  { id: 'r54', name: 'Fennel (Saunf)', rate: 400, unit: 'pack', category: 'Spices' },
  { id: 'r55', name: 'Fenugreek (Methi)', rate: 150, unit: 'pack', category: 'Spices' },
  { id: 'r56', name: 'Ajwain', rate: 300, unit: 'pack', category: 'Spices' },
  { id: 'r57', name: 'Star Anise', rate: 400, unit: 'pack', category: 'Spices' },
  { id: 'r58', name: 'Chili Powder', rate: 350, unit: 'pack', category: 'Spices' },
  { id: 'r59', name: 'Garam Masala', rate: 250, unit: 'pack', category: 'Spices' },
  { id: 'r60', name: 'Kasuri Methi', rate: 180, unit: 'pack', category: 'Spices' },
  // Salts, Sugars & Baking
  { id: 'r61', name: 'Iodized Salt', rate: 60, unit: 'kg', category: 'Salts' },
  { id: 'r62', name: 'Pink Salt', rate: 250, unit: 'pack', category: 'Salts' },
  { id: 'r63', name: 'Black Salt', rate: 200, unit: 'pack', category: 'Salts' },
  { id: 'r64', name: 'Brown Sugar', rate: 350, unit: 'pack', category: 'Sugar' },
  { id: 'r65', name: 'Jaggery (Gur)', rate: 400, unit: 'kg', category: 'Sugar' },
  { id: 'r66', name: 'Mishri', rate: 300, unit: 'pack', category: 'Sugar' },
  { id: 'r67', name: 'Baking Soda', rate: 80, unit: 'pack', category: 'Baking' },
  { id: 'r68', name: 'Baking Powder', rate: 150, unit: 'pack', category: 'Baking' },
  { id: 'r69', name: 'Yeast', rate: 180, unit: 'pack', category: 'Baking' },
  { id: 'r70', name: 'Custard Powder', rate: 200, unit: 'pack', category: 'Baking' },
  { id: 'r71', name: 'Jelly Powder', rate: 120, unit: 'pack', category: 'Baking' },
  // Beverages
  { id: 'r72', name: 'Green Tea (Sabz Chai)', rate: 350, unit: 'pack', category: 'Beverages' },
  { id: 'r73', name: 'Instant Coffee (Nescafe)', rate: 800, unit: 'pack', category: 'Beverages' },
  { id: 'r74', name: 'Milk Powder 400g', rate: 850, unit: 'pack', category: 'Beverages' },
  { id: 'r75', name: 'Jam-e-Shirin 800ml', rate: 380, unit: 'bottle', category: 'Beverages' },
  { id: 'r76', name: 'Tang 500g', rate: 550, unit: 'pack', category: 'Beverages' },
  { id: 'r77', name: 'Coke 1.5L', rate: 220, unit: 'bottle', category: 'Beverages' },
  { id: 'r78', name: 'Pepsi 1.5L', rate: 220, unit: 'bottle', category: 'Beverages' },
  { id: 'r79', name: 'Sting Energy Drink', rate: 100, unit: 'bottle', category: 'Beverages' },
  { id: 'r80', name: 'Mineral Water 1.5L', rate: 80, unit: 'bottle', category: 'Beverages' },
  { id: 'r81', name: 'Fruit Juice 1L', rate: 250, unit: 'pack', category: 'Beverages' },
  // Packaged Foods & Dairy
  { id: 'r82', name: 'Instant Noodles', rate: 60, unit: 'pack', category: 'Packaged' },
  { id: 'r83', name: 'Macaroni 400g', rate: 220, unit: 'pack', category: 'Packaged' },
  { id: 'r84', name: 'Pasta 500g', rate: 350, unit: 'pack', category: 'Packaged' },
  { id: 'r85', name: 'Vermicelli (Sewaian)', rate: 180, unit: 'pack', category: 'Packaged' },
  { id: 'r86', name: 'Cornflakes 375g', rate: 550, unit: 'pack', category: 'Packaged' },
  { id: 'r87', name: 'Oats 500g', rate: 550, unit: 'pack', category: 'Packaged' },
  { id: 'r88', name: 'Honey 500g', rate: 850, unit: 'bottle', category: 'Packaged' },
  { id: 'r89', name: 'Jam 450g', rate: 450, unit: 'bottle', category: 'Packaged' },
  { id: 'r90', name: 'Ketchup 800g', rate: 380, unit: 'bottle', category: 'Packaged' },
  { id: 'r91', name: 'Mayonnaise 500g', rate: 550, unit: 'bottle', category: 'Packaged' },
  { id: 'r92', name: 'Soy Sauce 200ml', rate: 250, unit: 'bottle', category: 'Packaged' },
  { id: 'r93', name: 'Vinegar 400ml', rate: 180, unit: 'bottle', category: 'Packaged' },
  { id: 'r94', name: 'Fresh Milk 1L', rate: 220, unit: 'pack', category: 'Dairy' },
  { id: 'r95', name: 'Yogurt (Dahi)', rate: 350, unit: 'kg', category: 'Dairy' },
  { id: 'r96', name: 'Butter 200g', rate: 380, unit: 'pack', category: 'Dairy' },
  { id: 'r97', name: 'Cheese Slice 200g', rate: 450, unit: 'pack', category: 'Dairy' },
  { id: 'r98', name: 'Eggs (Dozen)', rate: 350, unit: 'dozen', category: 'Dairy' },
  { id: 'r99', name: 'Bread Milk Pack', rate: 180, unit: 'pack', category: 'Bakery' },
  { id: 'r100', name: 'Rusk (Toast) 300g', rate: 250, unit: 'pack', category: 'Bakery' },
  // Snacks, Biscuits & Sweets
  { id: 'r101', name: 'Lays Chips Large', rate: 100, unit: 'pack', category: 'Snacks' },
  { id: 'r102', name: 'Nimko 200g', rate: 220, unit: 'pack', category: 'Snacks' },
  { id: 'r103', name: 'Peanuts (Moongfali)', rate: 500, unit: 'pack', category: 'Snacks' },
  { id: 'r104', name: 'Marie Biscuits Family', rate: 180, unit: 'pack', category: 'Snacks' },
  { id: 'r105', name: 'Sooper Biscuits', rate: 60, unit: 'pack', category: 'Snacks' },
  { id: 'r106', name: 'Prince Biscuits', rate: 60, unit: 'pack', category: 'Snacks' },
  { id: 'r107', name: 'Gluco Biscuits', rate: 30, unit: 'pack', category: 'Snacks' },
  { id: 'r108', name: 'Wafers (Kurkurey)', rate: 30, unit: 'pack', category: 'Snacks' },
  { id: 'r109', name: 'Bubble Gum Bottle', rate: 100, unit: 'bottle', category: 'Snacks' },
  { id: 'r110', name: 'Chocolate Bar (Dairy Milk)', rate: 200, unit: 'piece', category: 'Snacks' },
  { id: 'r111', name: 'Toffees Jar', rate: 500, unit: 'jar', category: 'Snacks' },
  { id: 'r112', name: 'Popcorn Kernels', rate: 300, unit: 'pack', category: 'Snacks' },
  { id: 'r113', name: 'Slanty', rate: 40, unit: 'pack', category: 'Snacks' },
  { id: 'r114', name: 'Almonds (Badam) 250g', rate: 900, unit: 'pack', category: 'Snacks' },
  { id: 'r115', name: 'Cashews (Kaju) 250g', rate: 1200, unit: 'pack', category: 'Snacks' },
  { id: 'r116', name: 'Raisins (Kishmish) 250g', rate: 450, unit: 'pack', category: 'Snacks' },
  { id: 'r117', name: 'Dates (Khajoor) 500g', rate: 800, unit: 'pack', category: 'Snacks' },
  // Personal Care & Hygiene
  { id: 'r118', name: 'Lifebuoy Soap', rate: 120, unit: 'piece', category: 'Personal Care' },
  { id: 'r119', name: 'Body Wash 250ml', rate: 450, unit: 'bottle', category: 'Personal Care' },
  { id: 'r120', name: 'Head & Shoulders Shampoo', rate: 550, unit: 'bottle', category: 'Personal Care' },
  { id: 'r121', name: 'Conditioner 200ml', rate: 500, unit: 'bottle', category: 'Personal Care' },
  { id: 'r122', name: 'Hair Oil (Dabur Amla)', rate: 350, unit: 'bottle', category: 'Personal Care' },
  { id: 'r123', name: 'Colgate Toothpaste 100g', rate: 220, unit: 'pack', category: 'Personal Care' },
  { id: 'r124', name: 'Toothbrush', rate: 80, unit: 'piece', category: 'Personal Care' },
  { id: 'r125', name: 'Gillette Razor', rate: 250, unit: 'piece', category: 'Personal Care' },
  { id: 'r126', name: 'Shaving Cream', rate: 320, unit: 'pack', category: 'Personal Care' },
  { id: 'r127', name: 'Talcum Powder 200g', rate: 250, unit: 'pack', category: 'Personal Care' },
  { id: 'r128', name: 'Vaseline 100g', rate: 350, unit: 'pack', category: 'Personal Care' },
  { id: 'r129', name: 'Tissue Box 200 pulls', rate: 220, unit: 'box', category: 'Personal Care' },
  { id: 'r130', name: 'Sanitary Pads (Always)', rate: 400, unit: 'pack', category: 'Personal Care' },
  { id: 'r131', name: 'Baby Diapers Canbebe M', rate: 1200, unit: 'pack', category: 'Personal Care' },
  { id: 'r132', name: 'Wet Wipes 80s', rate: 250, unit: 'pack', category: 'Personal Care' },
  // Household, Cleaning & Utilities
  { id: 'r133', name: 'Surf Excel 1kg', rate: 550, unit: 'pack', category: 'Household' },
  { id: 'r134', name: 'Laundry Bar (Bright)', rate: 60, unit: 'piece', category: 'Household' },
  { id: 'r135', name: 'Vim Dish Wash Liquid', rate: 250, unit: 'bottle', category: 'Household' },
  { id: 'r136', name: 'Steel Wool 3-pack', rate: 80, unit: 'pack', category: 'Household' },
  { id: 'r137', name: 'Dettol Phenyl 1L', rate: 320, unit: 'bottle', category: 'Household' },
  { id: 'r138', name: 'Harpic 500ml', rate: 320, unit: 'bottle', category: 'Household' },
  { id: 'r139', name: 'Mortein Spray 400ml', rate: 550, unit: 'bottle', category: 'Household' },
  { id: 'r140', name: 'Mosquito Coil Pack', rate: 100, unit: 'pack', category: 'Household' },
  { id: 'r141', name: 'Matchbox 10-pack', rate: 80, unit: 'pack', category: 'Household' },
  { id: 'r142', name: 'Candles Pack', rate: 60, unit: 'pack', category: 'Household' },
  { id: 'r143', name: 'AA Batteries 4-pack', rate: 220, unit: 'pack', category: 'Household' },
  { id: 'r144', name: 'Kiwi Shoe Polish', rate: 180, unit: 'piece', category: 'Household' },
  { id: 'r145', name: 'Osaka LED Bulb 12W', rate: 350, unit: 'piece', category: 'Household' },
  { id: 'r146', name: 'Fevicol Glue 100g', rate: 180, unit: 'piece', category: 'Household' },
  { id: 'r147', name: 'Shopper Bags Pack', rate: 100, unit: 'pack', category: 'Household' },
];
